...
int32_t main(void)
{
    ...
    printf("+--------------------------------------------------------+\n");
    printf("If PG.15 = 0, just report it is key 'a'.\n");

    /* Set PG.15 as Quasi-bidirectional mode */
    GPIO_SetMode(PG, BIT15, GPIO_MODE_QUASI);

    PG15 = 1;
    /* Set PF.11 as Quasi-bidirectional mode */
    GPIO_SetMode(PF, BIT11, GPIO_MODE_QUASI);
